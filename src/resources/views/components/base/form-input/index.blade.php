...
<input
    ...
    {{ $attributes->class(
            merge([
                ...
                $errors->has($attributes->get('name', 'wire:model')) ? 'border-red-400 dark:border-red-400 focus:ring-red-600 focus:ring-opacity-40' : 'border-slate-200',
            ]),
