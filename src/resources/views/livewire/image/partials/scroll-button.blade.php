<button
    ...
    class="fixed bottom-4 right-4 z-50 p-4 bg-pending border-pending text-white dark:border-pending rounded-full shadow-lg hover:bg-orange-500 focus:ring focus:ring-orange-300 flex flex-row"
    style="display: none;"
    >
    <x-base.lucide
        icon="arrow-up"
