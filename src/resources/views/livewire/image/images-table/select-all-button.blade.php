<div class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm text-gray-700 hover:bg-gray-50
    ...
    />
    <label for="selectAll" class="inline-block text-xs mt-0.5"> {{ __('Select all') }} </label>
</div>
