<label for="selectAll" class="inline-flex justify-center w-min-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm text-gray-700 hover:bg-gray-50
